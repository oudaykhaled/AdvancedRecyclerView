package com.appro.stickyheadercursorrecycleradapter.provider;
...
import com.appro.stickyheadercursorrecycleradapter.ApplicationContext;
...
public class InternalStorageContentProvider extends ContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://"+ ApplicationContext.getInstance().getPackageName()+"/");
